  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double radius =
            (size / 2) * 0.7; // Estimated internal radius scaling factor
            ...
            RadarChart(
              RadarChartData(
                ...
                getTitle: (index, angle) {
                  switch (index) {
                    case 0:
                      return const RadarChartTitle(text: 'FUN');
                    case 1:
                      return const RadarChartTitle(text: 'TECH');
                    case 2:
                      return const RadarChartTitle(text: 'COORD');
                    case 3:
      ...
      child: Transform.translate(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: PhoenixTheme.primary.withOpacity(0.5),
              width: 1,
            ),
          ),
          child: Text(
